	...
	public function register() {
		...
		if (!empty($this->request->data)) {
			...
			if ($user !== false) {
				...
				unset($this->request->data[$this->modelClass]['passwd']);
 ...
 */
	protected function _setCookie($options = array(), $cookieKey = 'User') {
		if (empty($this->request->data[$this->modelClass]['remember_me'])) {
			...
			$cookieData = array();
			$cookieData[$this->Auth->fields['username']] = $this->request->data[$this->modelClass][$this->Auth->fields['username']];
			$cookieData[$this->Auth->fields['password']] = $this->request->data[$this->modelClass][$this->Auth->fields['password']];
