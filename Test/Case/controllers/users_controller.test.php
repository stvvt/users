 ...
 */
	public function beforeFilter() {
		...
		$this->Auth->loginError = __d('users', 'Invalid e-mail / password combination.  Please try again');
 ...
 */
	public function testUserLogin() {
		...
		$this->Users->Component->startup($this->Users);
		$this->Users->login();
		$this->assertEqual($this->Users->Session->read('Message.flash.message'), __d('users', 'testuser you have successfully logged in'));
		...
		$this->Users->beforeFilter();
		$this->Users->login();
		$this->assertEqual($this->Users->Session->read('Message.auth.message'), __d('users', 'Invalid e-mail / password combination.  Please try again'));
	}
 ...
 */
	public function testLogout() {
		...
		$this->Users->logout();
		$this->assertEqual($this->Users->Session->read('Message.flash.message'), __d('users', 'floriank you have successfully logged out'));
